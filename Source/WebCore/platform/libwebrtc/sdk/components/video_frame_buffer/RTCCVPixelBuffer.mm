...
- (id<RTCI420Buffer>)toI420 {
  ...
  switch (pixelFormat) {
    ...
    case kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange: {
      ...
      int srcWidthY = CVPixelBufferGetWidthOfPlane(_pixelBuffer, 0);
      int srcHeightY = CVPixelBufferGetHeightOfPlane(_pixelBuffer, 0);
      int srcWidthUV = CVPixelBufferGetWidthOfPlane(_pixelBuffer, 1);
      int srcHeightUV = CVPixelBufferGetHeightOfPlane(_pixelBuffer, 1);
